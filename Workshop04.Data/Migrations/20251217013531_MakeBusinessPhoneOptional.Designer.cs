...
namespace Workshop04.Data.Migrations
{
    ...
    [Migration("20251217013531_MakeBusinessPhoneOptional")]
    partial class MakeBusinessPhoneOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workshop04.Data.Models.Agency", b =>
                {
            ...
            modelBuilder.Entity("Workshop04.Data.Models.CustomerPreferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerPreferences", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Workshop04.Data.Models.PackagesProductsSupplier", b =>
                {
                    ...
                    b.ToTable("Packages_Products_Suppliers", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Workshop04.Data.Models.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workshop04.Data.Models.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasOne("Workshop04.Data.Models.ProductsSupplier", "ProductsSupplier")
                        .WithMany()
                    ...
                    b.Navigation("ProductsSupplier");
                });

            modelBuilder.Entity("Workshop04.Data.Models.ProductsSupplier", b =>
                {
                    b.HasOne("Workshop04.Data.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId");

                    b.HasOne("Workshop04.Data.Models.Supplier", "Supplier")
                        .WithMany()
